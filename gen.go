...
// Compile-time assertion that AbortRepositoryMigrationInput implements the Input interface.
var _ Input = (*AbortRepositoryMigrationInput)(nil)

// isInput implements the Input interface.
func (AbortRepositoryMigrationInput) isInput() {}
...
// Compile-time assertion that AddPullRequestReviewThreadReplyInput implements the Input interface.
var _ Input = (*AddPullRequestReviewThreadReplyInput)(nil)

// isInput implements the Input interface.
func (AddPullRequestReviewThreadReplyInput) isInput() {}
...
// Compile-time assertion that CreateUserListInput implements the Input interface.
var _ Input = (*CreateUserListInput)(nil)

// isInput implements the Input interface.
func (CreateUserListInput) isInput() {}
...
// Compile-time assertion that DeleteUserListInput implements the Input interface.
var _ Input = (*DeleteUserListInput)(nil)

// isInput implements the Input interface.
func (DeleteUserListInput) isInput() {}
...
const (
	// EnterpriseMembersCanCreateRepositoriesSettingValueNoPolicy. Organization owners choose whether to allow members to create repositories.
...
// Compile-time assertion that EnterpriseOrder implements the Input interface.
var _ Input = (*EnterpriseOrder)(nil)

// isInput implements the Input interface.
func (EnterpriseOrder) isInput() {}
...
// Compile-time assertion that Environments implements the Input interface.
var _ Input = (*Environments)(nil)

// isInput implements the Input interface.
func (Environments) isInput() {}
...
const (
	...
	// FundingPlatformPolar. Polar funding platform.
	FundingPlatformPolar FundingPlatform = "POLAR"
	// FundingPlatformBuyMeACoffee. Buy Me a Coffee funding platform.
...
// Compile-time assertion that MarkNotificationAsDoneInput implements the Input interface.
var _ Input = (*MarkNotificationAsDoneInput)(nil)

// isInput implements the Input interface.
func (MarkNotificationAsDoneInput) isInput() {}
...
var _ Input = (*MarkProjectV2AsTemplateInput)(nil)

// isInput implements the Input interface.
func (MarkProjectV2AsTemplateInput) isInput() {}
...
const (
	...
	// OrgRemoveMemberAuditEntryMembershipTypeAdmin. Organization owners have full access and can change several settings, including the names of repositories that belong to the Organization and Owners team membership. In addition, organization owners can delete the organization and all of its repositories.
...
// Compile-time assertion that ProjectV2Collaborator implements the Input interface.
var _ Input = (*ProjectV2Collaborator)(nil)

// isInput implements the Input interface.
func (ProjectV2Collaborator) isInput() {}
...
const (
	// ProjectV2WorkflowsOrderFieldName. The name of the workflow.
	ProjectV2WorkflowsOrderFieldName ProjectV2WorkflowsOrderField = "NAME"
	// ProjectV2WorkflowsOrderFieldNumber. The number of the workflow.
	ProjectV2WorkflowsOrderFieldNumber ProjectV2WorkflowsOrderField = "NUMBER"
	// ProjectV2WorkflowsOrderFieldUpdatedAt. The date and time of the workflow update.
	ProjectV2WorkflowsOrderFieldUpdatedAt ProjectV2WorkflowsOrderField = "UPDATED_AT"
	// ProjectV2WorkflowsOrderFieldCreatedAt. The date and time of the workflow creation.
...
// Compile-time assertion that PropertyTargetDefinitionInput implements the Input interface.
var _ Input = (*PropertyTargetDefinitionInput)(nil)

// isInput implements the Input interface.
func (PropertyTargetDefinitionInput) isInput() {}
...
const (
	...
	// RepositoryLockReasonTransferringOwnership. The repository is locked due to an ownership transfer.
...
// Compile-time assertion that RepositoryPropertyConditionTargetInput implements the Input interface.
var _ Input = (*RepositoryPropertyConditionTargetInput)(nil)

// isInput implements the Input interface.
func (RepositoryPropertyConditionTargetInput) isInput() {}
...
// Compile-time assertion that RepositoryRuleOrder implements the Input interface.
var _ Input = (*RepositoryRuleOrder)(nil)

// isInput implements the Input interface.
func (RepositoryRuleOrder) isInput() {}
...
const (
	// RepositoryRuleOrderFieldUpdatedAt. Order repository rules by updated time.
	RepositoryRuleOrderFieldUpdatedAt RepositoryRuleOrderField = "UPDATED_AT"
	// RepositoryRuleOrderFieldCreatedAt. Order repository rules by created time.
	RepositoryRuleOrderFieldCreatedAt RepositoryRuleOrderField = "CREATED_AT"
	// RepositoryRuleOrderFieldType. Order repository rules by type.
...
const (
	...
	// RepositoryRuleTypeMergeQueue. Merges must be performed via a merge queue.
	RepositoryRuleTypeMergeQueue RepositoryRuleType = "MERGE_QUEUE"
	// RepositoryRuleTypeRequiredReviewThreadResolution. When enabled, all conversations on code must be resolved before a pull request can be merged into a branch that matches this rule.
	RepositoryRuleTypeRequiredReviewThreadResolution RepositoryRuleType = "REQUIRED_REVIEW_THREAD_RESOLUTION"
	// RepositoryRuleTypeRequiredDeployments. Choose which environments must be successfully deployed to before refs can be pushed into a ref that matches this rule.
	...
	// RepositoryRuleTypeRequiredStatusChecks. Choose which status checks must pass before the ref is updated. When enabled, commits must first be pushed to another ref where the checks pass.
	RepositoryRuleTypeRequiredStatusChecks RepositoryRuleType = "REQUIRED_STATUS_CHECKS"
	// RepositoryRuleTypeRequiredWorkflowStatusChecks. Require all commits be made to a non-target branch and submitted via a pull request and required workflow checks to pass before they can be merged.
	...
	// RepositoryRuleTypeAuthorization. Authorization.
	RepositoryRuleTypeAuthorization RepositoryRuleType = "AUTHORIZATION"
	// RepositoryRuleTypeTag. Tag.
	RepositoryRuleTypeTag RepositoryRuleType = "TAG"
	// RepositoryRuleTypeMergeQueueLockedRef. Merge queue locked ref.
	RepositoryRuleTypeMergeQueueLockedRef RepositoryRuleType = "MERGE_QUEUE_LOCKED_REF"
	// RepositoryRuleTypeLockBranch. Branch is read-only. Users cannot push to the branch.
	RepositoryRuleTypeLockBranch RepositoryRuleType = "LOCK_BRANCH"
	// RepositoryRuleTypeMaxRefUpdates. Max ref updates.
	...
	// RepositoryRuleTypeWorkflows. Require all changes made to a targeted branch to pass the specified workflows before they can be merged.
	RepositoryRuleTypeWorkflows RepositoryRuleType = "WORKFLOWS"
	// RepositoryRuleTypeSecretScanning. Secret scanning.
	RepositoryRuleTypeSecretScanning RepositoryRuleType = "SECRET_SCANNING"
	// RepositoryRuleTypeWorkflowUpdates. Workflow files cannot be modified.
...
const (
	...
	// SocialAccountProviderNpm. JavaScript package registry.
...
// Compile-time assertion that SponsorAndLifetimeValueOrder implements the Input interface.
var _ Input = (*SponsorAndLifetimeValueOrder)(nil)

// isInput implements the Input interface.
func (SponsorAndLifetimeValueOrder) isInput() {}
...
const (
	// SponsorAndLifetimeValueOrderFieldSponsorLogin. Order results by the sponsor's login (username).
	SponsorAndLifetimeValueOrderFieldSponsorLogin SponsorAndLifetimeValueOrderField = "SPONSOR_LOGIN"
	// SponsorAndLifetimeValueOrderFieldSponsorRelevance. Order results by the sponsor's relevance to the viewer.
	SponsorAndLifetimeValueOrderFieldSponsorRelevance SponsorAndLifetimeValueOrderField = "SPONSOR_RELEVANCE"
	// SponsorAndLifetimeValueOrderFieldLifetimeValue. Order results by how much money the sponsor has paid in total.
...
const (
	// SponsorshipPaymentSourceGitHub. Payment was made through GitHub.
	SponsorshipPaymentSourceGitHub SponsorshipPaymentSource = "GITHUB"
	// SponsorshipPaymentSourcePatreon. Payment was made through Patreon.
...
var _ Input = (*UnmarkProjectV2AsTemplateInput)(nil)

// isInput implements the Input interface.
func (UnmarkProjectV2AsTemplateInput) isInput() {}
...
// Compile-time assertion that UnsubscribeFromNotificationsInput implements the Input interface.
var _ Input = (*UnsubscribeFromNotificationsInput)(nil)

// isInput implements the Input interface.
func (UnsubscribeFromNotificationsInput) isInput() {}
...
// Compile-time assertion that UpdatePatreonSponsorabilityInput implements the Input interface.
var _ Input = (*UpdatePatreonSponsorabilityInput)(nil)

// isInput implements the Input interface.
func (UpdatePatreonSponsorabilityInput) isInput() {}
...
var _ Input = (*UpdateProjectV2CollaboratorsInput)(nil)

// isInput implements the Input interface.
func (UpdateProjectV2CollaboratorsInput) isInput() {}
...
// Compile-time assertion that UpdateUserListInput implements the Input interface.
var _ Input = (*UpdateUserListInput)(nil)

// isInput implements the Input interface.
func (UpdateUserListInput) isInput() {}
...
// Compile-time assertion that UpdateUserListsForItemInput implements the Input interface.
var _ Input = (*UpdateUserListsForItemInput)(nil)

// isInput implements the Input interface.
func (UpdateUserListsForItemInput) isInput() {}
...
// Compile-time assertion that WorkflowFileReferenceInput implements the Input interface.
var _ Input = (*WorkflowFileReferenceInput)(nil)

// isInput implements the Input interface.
func (WorkflowFileReferenceInput) isInput() {}
...
// Compile-time assertion that WorkflowsParametersInput implements the Input interface.
var _ Input = (*WorkflowsParametersInput)(nil)

// isInput implements the Input interface.
func (WorkflowsParametersInput) isInput() {}
