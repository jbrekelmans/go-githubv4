...
[![Go Reference](https://pkg.go.dev/badge/github.com/jbrekelmans/go-githubv4.svg)](https://pkg.go.dev/github.com/jbrekelmans/go-githubv4)

Package `githubv4` is a client library for accessing GitHub GraphQL API v4 (https://docs.github.com/en/graphql).

If you're looking for a client library for GitHub REST API v3, the recommended package is
[`github.com/google/go-github/github`](https://godoc.org/github.com/google/go-github/github).

Focus
-----

Follows the same slick design as [shurcooL/githubv4](https://github.com/shurcooL/githubv4):
...
If you are using GitHub Enterprise, use [`githubv4.NewEnterpriseClient`](https://godoc.org/github.com/jbrekelmans/githubv4#NewEnterpriseClient):
...
For each scalar in the GitHub GraphQL schema listed at https://docs.github.com/en/graphql/reference/scalars, there is a corresponding Go
type in package `githubv4` (except for Boolean, Float and Int you can use primitive data types).
...
- Dmitri Shuralyov for the slick design of [shurcooL/githubv4](https://github.com/shurcooL/githubv4).
